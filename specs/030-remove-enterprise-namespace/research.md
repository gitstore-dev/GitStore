...
| `docs/architecture/README.md`                                    | Update namespace tier table, remove `parentEnterpriseId` from examples                                                                                                                                                                               |
...
| `docs/resource-storage/git-backed.md`                            | Remove `parentEnterpriseRef` from namespace resource spec                                                                                                                                                                                            |
