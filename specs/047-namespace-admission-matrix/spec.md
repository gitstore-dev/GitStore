...
- **FR-003**: The system MUST report an attempt to change an immutable field (per GH#172) using a reason distinguishable from both a structural-validation failure and a policy-admission rejection.
