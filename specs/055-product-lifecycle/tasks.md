...
- [X] T025 [P] [US2] Add Product lookup/list/node/relationship/count cross-namespace authorization and no-disclosure tests in `gitstore-api/internal/graph/resolver/product_authorization_test.go`.
