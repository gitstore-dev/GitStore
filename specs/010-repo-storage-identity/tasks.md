...
- [X] T004 [P] Update `gitstore-api/internal/datastore/scylla/migrations/002_secondary_indexes.cql` in-place — add `repositories_by_namespace` and `mappings_by_repo_id` indices
...
- No migration files created — update `001_initial_schema.cql` and `002_secondary_indexes.cql` in-place (D-003, ALPHA)
