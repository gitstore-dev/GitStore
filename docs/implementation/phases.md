...
|--------------------|------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Phase 1 alpha**  | Finish the architecture proof for developer-facing foundation                            | ~~#123~~ ✅; ~~#126~~ ✅; ~~#67~~ ✅; ~~#77~~ ✅; ~~#82~~ ✅; ~~#84~~ ✅; ~~#134~~ ✅; ~~#135~~ ✅; ~~#137~~ ✅; ~~#143~~ ✅; **remaining open**: #79 File frontmatter; #173 Namespace Validation and Admission Matrix; #170 Declarative Namespace Resource Contract; #249 Repository Resource Contract                                                                                                                                                                                                                                                                                   | Push rejection diagnostics contract; initial File upload/object-storage decision ADR                                                                                                                                                                         | ~~#39~~, ~~#119~~, ~~#67~~ closed; ~~#225~~, ~~#226 phases 1–3~~ (auth specs 031–033) closed; ~~#246~~ closed                                                    | Git push is admission-controlled end-to-end in local/dev; all core alpha resources have stable contracts; GraphQL reads remain correct after admitted pushes; repository auth is enforced; local test/build/pr-ready gate is green |
| **Phase 2 beta**   | Complete core control-plane, reconciliation, Scylla, and pilot-grade catalog/config APIs | #131 Controller Watch API; #173 Namespace Validation; #174 Namespace Watch Contract; #176 Status subresource schema; #177 Status write boundaries; #178 Status concurrency semantics; #179 Status integration tests/authoring guide; #182 controller startup resume; #183 controller integration tests/runbook; #165 controller manager reconciliation loop; #244 CategoryTaxonomy controller; #230 auth runtime integration tests; **closed already**: ~~#135~~, ~~#137~~, ~~#227~~, ~~#228~~, ~~#229~~, ~~#246~~                                                                         | PriceList; PriceSet; PriceRule; CurrencyPolicy; stock-location and inventory-config resources; MediaAsset resource; auth service-token and SSH-key management issues; controller conformance suite by resource kind                                          | Alpha admission/lifecycle baseline (#79, #173, #170, #249 closed); ~~variant-first contract (#143)~~ ✅; watch/status semantics must sit on monotonic `resourceVersion` | Pilot users can run against Scylla with stable-ish APIs; controllers can list/watch/resume safely; authn/authz foundation is in place; pricing and inventory configuration resources exist; operational runbooks exist             |
