...
### 2.2a Sequence: synchronous pre-receive validation that rejects a push
...
### 11.2 Sequence: asynchronous event retry and dead-letter flow (recommended v2 design, not current behavior)
...
### 9.6a Sequence: extension configuration authorization and secret resolution
