...
pub mod catalog_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn validate_resources(
            &mut self,
            request: impl tonic::IntoRequest<super::ValidateResourcesRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/gitstore.catalog.v1.CatalogService/ValidateResources",
            );
        ...
        pub async fn admit_resources(
            ...
            tonic::Response<super::AdmitResourcesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gitstore.catalog.v1.CatalogService/AdmitResources",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod catalog_service_server {
    ...
    pub trait CatalogService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn admit_resources(
            &self,
            request: tonic::Request<super::AdmitResourcesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AdmitResourcesResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gitstore.catalog.v1.CatalogService/ValidateResources" => {
                    ...
                    struct ValidateResourcesSvc<T: CatalogService>(pub Arc<T>);
                    impl<
                        T: CatalogService,
                    > tonic::server::UnaryService<super::ValidateResourcesRequest>
                    for ValidateResourcesSvc<T> {
                        type Response = super::ValidateResourcesResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as CatalogService>::validate_resources(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gitstore.catalog.v1.CatalogService/AdmitResources" => {
                    #[allow(non_camel_case_types)]
                    struct AdmitResourcesSvc<T: CatalogService>(pub Arc<T>);
                    impl<
                        T: CatalogService,
                    > tonic::server::UnaryService<super::AdmitResourcesRequest>
                    for AdmitResourcesSvc<T> {
                        type Response = super::AdmitResourcesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CatalogService>::admit_resources(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AdmitResourcesSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "gitstore.catalog.v1.CatalogService";
